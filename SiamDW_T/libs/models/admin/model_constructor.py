...
class NetConstructor:
    """ Class to construct networks. Takes as input the function name, the name of the module
    which contains the network function  and the arguments for the network
    ...
    def __init__(self, fun_name, fun_module, args, kwds):
        ...
        """
        self.fun_name = 'aas_resnet50'
        self.fun_module = 'models.models.bbreg.aas'
        self.args = args
        self.kwds = kwds
