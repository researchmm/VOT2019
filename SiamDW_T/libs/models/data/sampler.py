...
class AASSampler(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        while not enough_visible_frames:
            ...
            rgb_anno, t_anno, visible = dataset.get_sequence_info(seq_id)
        ...
        # Get frames
        rgb_train_frames, t_train_frames, rgb_train_anno, t_train_anno, _ = dataset.get_frames(seq_id, train_frame_ids, t_anno)
        rgb_test_frames, t_test_frames, rgb_test_anno, t_test_anno, _ = dataset.get_frames(seq_id, test_frame_ids, t_anno)

        # Prepare data
        data = TensorDict({'rgb_train_images': rgb_train_frames,
                           'rgb_train_anno': rgb_train_anno,
                           'rgb_test_images': rgb_test_frames,
                           'rgb_test_anno': rgb_test_anno,
                           't_train_images': t_train_frames,
                           't_train_anno': t_train_anno,
                           't_test_images': t_test_frames,
                           't_test_anno': t_test_anno,
