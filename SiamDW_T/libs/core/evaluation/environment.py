...
class EnvSettings:
    def __init__(self):
        ...
        self.results_path = '{}/tracking_results/'.format(core_path)
        self.network_path = '{}/networks/'.format(core_path)
        self.otb_path = ''
        self.nfs_path = ''
        self.uav_path = ''
        self.tpl_path = ''
...
def create_default_local_file():
    ...
    with open(path, 'w') as f:
        ...
        f.write('from libs.core.evaluation.environment import EnvSettings\n\n')
...
def env_settings():
    env_module_name = 'core.evaluation.local'
    # try:
