import torch
from core.features.preprocessing import sample_patch
...
class MultiResolutionExtractor(ExtractorBase):
    ...
    def write(self, im):
        ...
        cv2.imwrite("/data/home/v-had/Tmsrasia_MSM/v-had/debug.jpg", img)
    ...
    def extract(self, im, pos, scales, image_sz, flag):
        ...
        feature_map = TensorList([f.get_feature(im_patches, flag) for f in self.features]).unroll()
