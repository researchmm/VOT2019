from core.utils import TrackerParams, FeatureParams, Choice
from core.features.extractor import MultiResolutionExtractor
from core.features import deep
import torch

def parameters(ckid):
    params = TrackerParams()

    params.short_term = True
    ...
    params.hard_negative_CG_iter = 20            # Number of optimization iterations to use if hard negative detected
    ...
    deep_feat = deep.AASResNet18(net_path='sharenet.pth.tar'.format(ckid), output_layers=['layer3'], fparams=deep_fparams,
                                  normalize_power=2)
