...
def resnext101_64_dropout(iou_input_dim=(256,256), iou_inter_dim=(256,256), backbone_pretrained=False, path=None):
...
def senet154(iou_input_dim=(256,256), iou_inter_dim=(256,256), backbone_pretrained=False, path=None):
    output_layers = ['layer2', 'layer3']
    channel = [512, 1024]
    # backbone
    backbone_net = backbones.senet154(output_layers=output_layers, pretrained=backbone_pretrained, path=path)

    # Bounding box regressor
    iou_predictor = bbmodels.IoUNet(input_dim=(channel[0], channel[1]), pred_input_dim=iou_input_dim,
                                        pred_inter_dim=iou_inter_dim)
...
def resnext101_64(iou_input_dim=(256,256), iou_inter_dim=(256,256), backbone_pretrained=False, path=None):
    output_layers = ['layer2', 'layer3']
    channel = [512, 1024]
