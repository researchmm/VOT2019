...
class Resnextlibs(BaseTracker):
    ...
    def initialize(self, raw_im, image, depth_im, state):
        # Initialize SiamRPN
        ...
        # initialize FPN
        self.fpn_cfg = mmcv.Config.fromfile(osp.join(main_path, 'FPNlib/configs/rpn_r50_fpn_1x.py'))
