...
def parameters():
    ...
    params.main_path = '$CODE-PATH/SiamDW_LT/far/'
    ...
    deep_feat = deep.ATOMResNet50(net_path=osp.join(params.main_path, 'networks/main/resnext_64_TLVC.pth.tar'), output_layers=['layer3'], fparams=deep_fparams,
                                  normalize_power=2)
