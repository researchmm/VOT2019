...
def VOTLT19Dataset():
    return VOTLT19DatasetClass().get_sequence_list()

def get_video_keys():
    return VOTLT19DatasetClass()._get_sequence_list()

class VOTLT19DatasetClass(BaseDataset):
    """
    VOTLT2019 dataset
    """
    def __init__(self):
        super().__init__()
        self.base_path = self.env_settings.votlt19_path
