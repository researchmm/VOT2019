from libs.utils import TrackerParams, FeatureParams
...
def parameters():
    ...
    params.flip_tracker = 'star'
    params.flip_name = 'resnext64_dropout_TLVC'
    ...
    deep_feat = deep.ATOMResNet50(net_path='res50_TLVC.pth', output_layers=['layer3'], fparams=deep_fparams,
                                  normalize_power=2)
